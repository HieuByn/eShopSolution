...
namespace eShopSolution.Application.Catalog.Products
{
    public class PublicProductService : IPublicProductService
    {
        ...
        public async Task<List<ProductViewModelDto>> GetAll(string languageId)
        {
            ...
            var data = await query.Select(x => new ProductViewModelDto()
                            {
                                Id = x.p.Id,
                                Name = x.pt.Name,
        ...
        public async Task<PagedResultDto<ProductViewModelDto>> GetAllByCategoryId(GetPublicProductPagingRequest request)
        {
            var query = from p in _context.Products
